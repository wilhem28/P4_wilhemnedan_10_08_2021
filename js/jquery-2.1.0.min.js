...
!(function (n, t) {
  ...
  function ur(n, t, r) {
    ...
    if (void 0 === r && 1 === n.nodeType)
      if (
        ((u = "data-" + t.replace(hf, "-$1").toLowerCase()),
        (r = n.getAttribute(u)),
        "string" == typeof r)
      ) {
        try {
  ...
  function pr(n) {
    ...
    return (
      t ||
        ...
        ("none" !== t && t) ||
          ((vt = (
            vt || i("<iframe frameborder='0' width='0' height='0'/>")
        ...
        u.style &&
          ...
          t
            ? (o[f] || "none" !== e || (u.style.display = ""),
              "" === u.style.display &&
                it(u) &&
                (o[f] = r.access(u, "olddisplay", pr(u.nodeName))))
            : o[f] ||
              ((s = it(u)),
              ((e && "none" !== e) || !s) &&
  ...
  function eu(n, t, i) {
    for (
      var u, f = (ut[t] || []).concat(ut["*"]), r = 0, e = f.length;
      e > r;
      r++
    )
  ...
  function fe(n, t, u) {
    ...
    for (f in t)
      if (((l = t[f]), re.exec(l))) {
        if (
          (delete t[f], (p = p || "toggle" === l), l === (h ? "hide" : "show"))
        ) {
  ...
  function ai(n, t, r, u) {
    ...
    if (i.isArray(t))
      i.each(t, function (t, i) {
        r || pe.test(n)
          ? u(n, i)
          : ai(n + "[" + ("object" == typeof i ? t : "") + "]", i, r, u);
      });
    else if (r || "object" !== i.type(t)) u(n, t);
    else for (f in t) ai(n + "[" + f + "]", t[f], r, u);
  }
  function ku(n) {
  ...
  y = (function (n) {
    ...
    p = u.setDocument = function (n) {
      var a,
        ...
        h = u.defaultView;
      return u !== e && 9 === u.nodeType && u.documentElement
        ? ((e = u),
          (v = u.documentElement),
          (l = !oi(u)),
          h &&
    ...
    u.matchesSelector = function (n, t) {
      if (
        ...
        (t = t.replace(ir, "='$1']")),
        !(!r.matchesSelector || !l || (g && g.test(t)) || (o && o.test(t))))
      )
        try {
          var i = ct.call(n, t);
          if (
  ...
  i.fn.extend({
    ...
    is: function (n) {
      return !!fi(this, "string" == typeof n && ki.test(n) ? i(n) : n || [], !1)
        .length;
    },
  });
  gi = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    ...
    if ("string" == typeof n) {
      ...
      if (r[1]) {
        if (
          ...
          i.merge(
            this,
            i.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : u, !0)
          ),
          di.test(r[1]) && i.isPlainObject(t))
        )
          for (r in t)
    ...
    closest: function (n, t) {
      for (
        var r,
          ...
          o = this.length,
          u = [],
          e = ki.test(n) || "string" != typeof n ? i(n, t || this.context) : 0;
        o > f;
        f++
      )
    ...
    function (n, t) {
      i.fn[n] = function (r, u) {
        ...
        return (
          ...
          this.length > 1 && (ir[n] || i.unique(f), tr.test(n) && f.reverse()),
          this.pushStack(f)
        );
      };
    }
  ...
  i.Callbacks = function (n) {
    ...
    var u,
      ...
      l = function (i) {
        for (
          u = n.memory && i, h = !0, e = c || 0, c = 0, f = t.length, o = !0;
          t && f > e;
          e++
        )
    ...
    return (
      ht ||
        ...
        "complete" === u.readyState
          ? setTimeout(i.ready)
          : (u.addEventListener("DOMContentLoaded", ct, !1),
      ...
      return "object" == typeof n
        ...
        : l(
            ...
            function (t) {
              ...
              if (u && void 0 === t) {
                if (
                  ((r = e.get(u, n)), void 0 !== r) ||
                  ((r = e.get(u, f)), void 0 !== r) ||
                  ((r = ur(u, f, void 0)), void 0 !== r)
                )
                  return r;
              } else
                this.each(function () {
  ...
  i.event = {
            ...
            o &&
              ...
              (l = p[o]) ||
                ...
                (s.setup && s.setup.call(n, f, k, y) !== !1) ||
                  (n.addEventListener && n.addEventListener(o, y, !1))),
              s.add &&
      ...
      if (y && (v = y.events)) {
        for (t = (t || "").match(c) || [""], w = t.length; w--; )
          if (
            ...
            k &&
              !a.length &&
              ((l.teardown && l.teardown.call(n, b, y.handle) !== !1) ||
                i.removeEvent(n, o, y.handle),
              delete v[o]);
    ...
    trigger: function (t, f, e, o) {
      ...
      if (
        ...
        if (!o && !l.noBubble && !i.isWindow(e)) {
          for (
            b = l.delegateType || h, er.test(b + h) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            p.push(s), (c = s);
    ...
    fix: function (n) {
      ...
      for (
        t ||
          (this.fixHooks[r] = t =
            lf.test(r) ? this.mouseHooks : cf.test(r) ? this.keyHooks : {}),
  ...
  i.extend({
    clone: function (n, t, r) {
      ...
      return (
        (e = o(h, "script")), e.length > 0 && oi(e, !l && o(n, "script")), h
      );
    },
    buildFragment: function (n, t, r, u) {
          ...
          if ("object" === i.type(f)) i.merge(v, f.nodeType ? [f] : f);
            ...
            for (
              e = e || s.appendChild(t.createElement("div")),
                y = (cr.exec(f) || ["", ""])[1].toLowerCase(),
                l = h[y] || h._default,
                e.innerHTML = l[1] + f.replace(hr, "<$1></$2>") + l[2],
                a = l[0];
              a--;
      ...
      for (s.textContent = "", c = 0; (f = v[c++]); )
        if (
          (!u || -1 === i.inArray(f, u)) &&
          ((p = i.contains(f.ownerDocument, f)),
          (e = o(s.appendChild(f), "script")),
          p && oi(e),
          r)
        )
          for (a = 0; (f = e[a++]); ) lr.test(f.type || "") && r.push(f);
      return s;
    },
    cleanData: function (n) {
      for (
        var o, t, s, f, u, h, l = i.event.special, c = 0;
        void 0 !== (t = n[c]);
        c++
      ) {
  ...
  i.fn.extend({
    ...
    remove: function (n, t) {
      for (
        var r, f = n ? i.filter(n, this) : this, u = 0;
        null != (r = f[u]);
        u++
      )
        t || 1 !== r.nodeType || i.cleanData(o(r)),
          r.parentNode &&
            (t && i.contains(r.ownerDocument, r) && oi(o(r, "script")),
    ...
    domManip: function (n, t) {
      ...
      if (
        ...
        for (s = i.map(o(h, "script"), bf), c = s.length; l > e; e++)
          (u = h),
            e !== b &&
              ((u = i.clone(u, !0, !0)), c && i.merge(s, o(u, "script"))),
            t.call(this[e], u, e);
        if (c)
          for (
            y = s[s.length - 1].ownerDocument, i.map(s, kf), e = 0;
            c > e;
            e++
          )
            (u = s[e]),
              lr.test(u.type || "") &&
                ...
                (u.src
                  ...
                  : i.globalEval(u.textContent.replace(wf, "")));
      }
      return this;
    },
  });
    ...
    n.getComputedStyle &&
      i.extend(f, {
        ...
        reliableMarginRight: function () {
          ...
          return (
            (i.style.cssText = t.style.cssText = c),
  ...
  i.extend({
    ...
    style: function (n, t, r, u) {
      if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
        var o,
          ...
          h = n.style;
        return (
          (t = i.cssProps[s] || (i.cssProps[s] = gr(h, s))),
          (e = i.cssHooks[t] || i.cssHooks[s]),
          void 0 === r
            ? e && "get" in e && void 0 !== (o = e.get(n, !1, u))
              ? o
              : h[t]
            : ((c = typeof r),
              "string" === c &&
                (o = te.exec(r)) &&
                ((r = (o[1] + 1) * o[2] + parseFloat(i.css(n, t))),
                (c = "number")),
              null != r &&
                r === r &&
                ("number" !== c || i.cssNumber[s] || (r += "px"),
                f.clearCloneStyle ||
                  "" !== r ||
    ...
    css: function (n, t, r, u) {
      var f,
        ...
        o = i.camelCase(t);
      return (
        (t = i.cssProps[o] || (i.cssProps[o] = gr(n.style, o))),
  ...
  i.each(["height", "width"], function (n, t) {
    i.cssHooks[t] = {
      get: function (n, r, u) {
        if (r)
          return 0 === n.offsetWidth && gf.test(i.css(n, "display"))
            ? i.swap(n, ie, function () {
                return iu(n, t, u);
              })
            : iu(n, t, u);
      },
      set: function (n, r, u) {
        ...
        return nu(
          n,
          r,
          u ? tu(n, t, u, "border-box" === i.css(n, "boxSizing", !1, f), f) : 0
        );
      },
    };
  });
  ...
  i.extend({
    attr: function (n, t, r) {
      var u,
        ...
        e = n.nodeType;
      if (n && 3 !== e && 8 !== e && 2 !== e)
        return typeof n.getAttribute === d
          ? i.prop(n, t, r)
          : ((1 === e && i.isXMLDoc(n)) ||
              ((t = t.toLowerCase()),
  ...
  i.extend({
    ...
    propHooks: {
      tabIndex: {
        get: function (n) {
          return n.hasAttribute("tabindex") || hu.test(n.nodeName) || n.href
            ? n.tabIndex
            : -1;
        },
      },
  ...
  i.fn.extend({
      ...
      if (h)
        for (o = (n || "").match(c) || []; l > e; e++)
          if (
            ...
            (r =
              1 === t.nodeType &&
              (t.className ? (" " + t.className + " ").replace(kt, " ") : " ")))
          ) {
            for (s = 0; (u = o[s++]); )
              r.indexOf(" " + u + " ") < 0 && (r += u + " ");
            f = i.trim(r);
        ...
        : this.each(
            i.isFunction(n)
              ...
              : function () {
                  if ("string" === u)
                    for (
                      var t, e = 0, f = i(this), o = n.match(c) || [];
                      (t = o[e++]);
    ...
    hasClass: function (n) {
      for (var i = " " + n + " ", t = 0, r = this.length; r > t; t++)
        if (
          1 === this[t].nodeType &&
          (" " + this[t].className + " ").replace(kt, " ").indexOf(i) >= 0
        )
          return !0;
      return !1;
    },
      ...
      return arguments.length
        ...
        ? ((t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()]),
          t && "get" in t && void 0 !== (r = t.get(u, "value"))
            ? r
            : ((r = u.value),
              "string" == typeof r ? r.replace(cu, "") : null == r ? "" : r))
        : void 0;
    },
  });
  i.extend({
  ...
  i.extend({
    ...
    ajax: function (n, t) {
          ...
          v
            ? (r.ifModified &&
              ...
              204 === n || "HEAD" === r.type
                ...
                : 304 === n
                ? (c = "notmodified")
                : ((c = y.state), (it = y.data), (b = y.error), (v = !b)))
            : ((b = c), (n || !c) && ((c = "error"), 0 > n && (n = 0))),
          (u.status = n),
          (u.statusText = (t || c) + ""),
      ...
      r.hasContent ||
        (r.data &&
          ((f = r.url += (gt.test(f) ? "&" : "?") + r.data), delete r.data),
        r.cache === !1 &&
          (r.url = lu.test(f)
            ? f.replace(lu, "$1_=" + dt++)
            : f + (gt.test(f) ? "&" : "?") + "_=" + dt++));
  ...
  return (
    ...
    (i.fn.load = function (n, t, r) {
      ...
      var u,
        ...
        e = n.indexOf(" ");
      return (
        e >= 0 && ((u = n.slice(e)), (n = n.slice(0, e))),
        i.isFunction(t)
          ? ((r = t), (t = void 0))
          : t && "object" == typeof t && (o = "POST"),
        f.length > 0 &&
          i
            .ajax({ url: n, type: o, dataType: "html", data: t })
            .done(function (n) {
              s = arguments;
      ...
      offset: function (n) {
        ...
        if (e)
          return (
            (r = e.documentElement),
            i.contains(r, t)
              ? (typeof t.getBoundingClientRect !== d &&
            ...
            function (t, i, f) {
              ...
              return void 0 === f
                ? e
                  ...
                  : t[i]
                : void (e
                    ? e.scrollTo(u ? n.pageXOffset : f, u ? f : n.pageYOffset)
                    : (t[i] = f));
            },
            t,
            i,
